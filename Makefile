...
LIBRARIES=-lm
CODE_DIRECTORY=code
_DEPENDENCIES=debug.hpp SILT_key.hpp SILT_key.tpp Small_Index_Large_Table.hpp Small_Index_Large_Table.tpp Log_store.hpp Log_store.tpp Hash_store.hpp Hash_store.tpp Merge_heap.hpp Sorted_store.hpp Sorted_store.tpp
